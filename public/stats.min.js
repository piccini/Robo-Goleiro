...
for(a.appendChild(c);74>c.children.length;){var j=document.createElement("span");
...
k.innerHTML="MS";d.appendChild(k);var e=document.createElement("div");
e.id="msGraph";
...
var t=function(b){
 s=b;
 switch(s){case 0:a.style.display="block";
 ...
 g=b-l;n=Math.min(n,g);o=Math.max(o,g);
